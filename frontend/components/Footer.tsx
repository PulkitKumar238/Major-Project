        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 lg:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Your comprehensive portal for discovering academic conferences, workshops, seminars, and symposia. 
              Connecting students, faculty, and researchers with opportunities worldwide.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/seminars" className="text-gray-300 hover:text-white transition-colors">
                  Seminars
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">contact@academichub.com</span>
              </li>
              <li className="flex items-center space-x-2">
              ...
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">Global Academic Network</span>
              </li>
            </ul>
          </div>
        </div>
